...
public class Morph_Main {
	...
	//	String [] list ={"cau", "hufs", "hyu", "korea", "kyunghee", "skku", "snu", "sogang", "uos", "yonsei"};
		String [] list = {"cau_10000", "cau_25000"};
		for(String name : list) {
			...
			try {
				FileWriter fWriter = new FileWriter(university+"_analysis.txt");
